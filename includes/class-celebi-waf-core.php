...
class CELEBI_WAF_Core {
    ...
    private function __construct() {
        ...
        add_action('wp_ajax_celebi_waf_threat_reputation_list', [$this, 'ajax_threat_reputation_list']);
        add_action('wp_ajax_celebi_waf_save_threat_reputation', [$this, 'ajax_save_threat_reputation']);
